...
public class DataSourceConfigurer {
     ...
     */
    @Bean("Gamma")
    @ConfigurationProperties(prefix = "spring.datasource.druid.Gamma")
    public DataSource Gamma() {
        return DruidDataSourceBuilder.create().build();
    }
    /**
     * Dynamic data source.
    ...
    public DataSource dynamicDataSource() {
        ...
        dataSourceMap.put("Gamma", Gamma());
        dataSourceMap.put("Beta", Beta());
        dataSourceMap.put("Alpha", Alpha());
